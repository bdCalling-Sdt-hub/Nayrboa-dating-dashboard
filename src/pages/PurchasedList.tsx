...
const PurchasedPackageList = () => {
  ...
  return (
    <div className="bg-[#232D32] rounded p-4 mt-2 " style={{ height: "100%" }}>
      {/* start  Search bar , filter , date   */}
      <div
        className=" flex justify-between items-center px-0 pr-5"
        style={{
          height: "80px",
        }}
      >
        ...
        <div className="flex items-center gap-5">
          <div className="max-w-md   text-white border border-white rounded-md">
            <div className="relative flex items-center w-[352px] h-10 rounded-lg focus-within:shadow-lg bg-[#1C2428] overflow-hidden">
